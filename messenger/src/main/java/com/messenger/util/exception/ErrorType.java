...
public enum ErrorType {
    ...
    GOOGLE_AUTHENTICATION_EXCEPTION("error.googleAuthenticationException", HttpStatus.UNAUTHORIZED),
    AUTHENTICATION_EXCEPTION("error.authenticationException", HttpStatus.UNAUTHORIZED);
