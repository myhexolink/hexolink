...
import com.messenger.util.ValidationUtil;
import com.messenger.util.exception.*;
...
import static com.messenger.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public ResponseEntity<ErrorInfo> bindValidationError(HttpServletRequest req, BindException e) {
        String[] details = e.getBindingResult().getFieldErrors().toArray(String[]::new);
